			...
			if ($check == 0 ) {
				if ($email_check == 0) {
					...
					if (strlen($_POST['password']) >4 ) {
						...
						$result = mysqli_query($db,"INSERT INTO users (first_name,username,email,password,gender,sign_up_date,activated,Category) VALUES ('$_POST[first_name]','$_POST[Second_name]','$_POST[email]','$_POST[password]','$_POST[gender]','$d','0','$_POST[cat]')");
		...
		<div class="navbar-inner">
			...
			<div class="wrapper">
							...
							<div>
							   ...
							   ?>
									...
									<?php 
										...
										else{ echo'<div><div style=" background-color:#f0f; border:1px solid #f0f; color:white; top:10%;width:102%"  class="alert alert-info">Enter your username or email address below., We will then send a special link to your email. After you click on that link, you will be asked to enter a new password.</div>';}
									?>
									</div>
				...
				<div class="module12 module-login span4 offset4" >
									...
									<div>
							<h3>Sign In AS :pls select category</h3>
						</div>
										<div class="module-body">
											<div>
												<label class=""><b style="position:relative; top:22px">PATIENT</b><b style="background-color:white; border: 1.3px solid #f0f;color:#31708f"class="  label green pull-left"><input onclick="check()" type="checkbox" value="pt."   name="cat" ><img src="follow3s.png" width="80%"></b></b></label>
				  <label class=""><b style="position:relative; float:right;top:22px"><a href="sigup - Dr.php"> DOCTOR</a></b><b style="background-color:white; border: 1.3px solid #05edfc; border-bottom: solid #f8f8f8 ;color:#31708f"class="  label green pull-right"><img src="Capturedr.png"  width="40%" onclick="check1()" ><img src="follow3.png" width="80%"></a></b></b></label><br><br>
				  
			
		<hr style="border: 1.3px solid #08e1ea">
		
		<div class="control-group" data-validate="Name is required">
						<div class="controls row-fluid">
									
												     <input name="first_name"  style="background-color: #ffffff;
border: 1.3px solid #f0f;color:#31708f;"class="span12" id="first_name" placeholder="First name" required="required" onBlur="checkusername()" onkeyup="clean('username')" onkeydown="clean('username')" class="user_name signupbox signupbox_wihei" type="text" size="30" value="" >
		
												<td style=" margin: 10px; padding: 2px; background-color: white;">
												<p id="usernamestatus"></p>

												</td>
												<input name="Second_name" id="Second_name" class="span12" style="background-color: #ffffff;
border: 1.3px solid #f0f"  placeholder="Second name" required="required"  type="text" size="30" value="" >
...
border: 1.3px solid #f0f"  placeholder="Email..@xyz.com" required="required" class="email signupbox signupbox_wihei" type="email" size="30" value="">
                                                												<td style=" margin: 10px; padding: 2px; background-color: white;">
												<p id="emailstatus"></p>
...
border: 1.3px solid #f0f;border-bottom:1.3px solid white" name="password"  class="span12" id="password-1" required="required" style="overflow: hidden; padding-right: 7px;" placeholder="Enter New Password" class="password signupbox passbox_wihei" type="password" size="30" value="">
...
border: 1.3px solid #f0f;border-top:1.3px solid white" name="passwords"  class="span12" id="password-1" required="required" style="overflow: hidden; padding-right: 7px;" placeholder="cofirm New Password" class="password signupbox passbox_wihei" type="password" size="30" value="">
											
											</div></div><hr><input  onBlur="checktell()" onkeyup="clean('tell')" id="phone" name="phone" style="height:20%" type="tel" value="+237">
											<td style=" margin: 10px; padding: 2px; background-color: white;">
												<p id="emailstatus"></p>
