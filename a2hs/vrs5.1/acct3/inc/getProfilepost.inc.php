<?php
	...
	$get_posted_to_info = mysqli_query($db,"SELECT * FROM users WHERE username='$user_posted_to'");
	...
	//showing data on profile
			...
			if ($user_posted_to == $added_by) {
				...
				$note_check =  mysqli_query($db,"SELECT * FROM posts WHERE id='$id'");
				$get_note = mysqli_fetch_assoc($note_check);
